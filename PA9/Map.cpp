...
void Map::loadRoomTextures() {
	sf::Texture room1;
	room1.loadFromFile("MapTextures/Room1.png");
	roomTextures[0] = room1;
	sf::Texture room2;
	room2.loadFromFile("MapTextures/Room2.png");
	roomTextures[1] = room2;
	sf::Texture room3;
	room3.loadFromFile("MapTextures/Room3.png");
	roomTextures[2] = room3;
	sf::Texture room4;
	room4.loadFromFile("MapTextures/Room4.png");
	roomTextures[3] = room4;
	sf::Texture room5;
	room5.loadFromFile("MapTextures/Room5.png");
	roomTextures[4] = room5;
	sf::Texture room6;
	room6.loadFromFile("MapTextures/Room6.png");
	roomTextures[5] = room6;
	sf::Texture room7;
	room7.loadFromFile("MapTextures/Room7.png");
	roomTextures[6] = room7;
	sf::Texture room8;
	room8.loadFromFile("MapTextures/Room8.png");
	roomTextures[7] = room8;
	sf::Texture room9;
	room9.loadFromFile("MapTextures/Room9.png");
	roomTextures[8] = room9;
	sf::Texture room10;
	room10.loadFromFile("MapTextures/Room10.png");
	roomTextures[9] = room10;
	sf::Texture room11;
	room11.loadFromFile("MapTextures/Room11.png");
	roomTextures[10] = room11;
	sf::Texture room12;
	room12.loadFromFile("MapTextures/Room12.png");
	roomTextures[11] = room12;
	sf::Texture room13;
	room13.loadFromFile("MapTextures/Room13.png");
	roomTextures[12] = room13;
	sf::Texture room14;
	room14.loadFromFile("MapTextures/Room14.png");
